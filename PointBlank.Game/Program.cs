...
namespace PointBlank.Game
{
  public class Programm
  {
    public static void Main(string[] args)
    {
      ...
      Console.Title = "Point Blank - Games";
      Logger.StartedFor = "Game";
      Logger.checkDirectorys();
      Console.Clear();
      Logger.title("_______________________________________________________________________________");
      Logger.title("                                                                               ");
      Logger.title("                                                                               ");
      Logger.title("                                POINT BLANK GAMES                              ");
      Logger.title("                                                                               ");
      Logger.title("                                                                               ");
      Logger.title("_______________________________ " + str1 + " __________________________________");
      GameConfig.Load();
